...
def save_model(args, model, optimizer, run):
    ...
    model_path = f'models/{args.dataset}/{run}_{args.beta}_{args.length}_{args.window_size}_{args.sample_rate}_{args.seq_layer_type}_{args.walk_encoder_dropout}.pt'
...
def save_result(args, results):
    ...
    filename = f'results/{args.dataset}/{args.length}_{args.window_size}_{args.sample_rate}_{args.seq_layer_type}_{args.walk_encoder_dropout}.csv'
