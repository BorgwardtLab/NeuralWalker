...
def parse_method(args, n, c, d, device):
    model = Polynormer(d, args.hidden_channels, c, local_layers=args.local_layers, global_layers=args.global_layers,
            ...
            heads=args.num_heads, beta=args.beta, pre_ln=args.pre_ln,
...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--seq_layer_type', type=str, default='conv')
    parser.add_argument('--d_conv', type=int, default=9)
    parser.add_argument('--walk_encoder_dropout', type=float, default=0.5)
